...
//            }
//
//            if (!roomId.isEmpty() && referenceRecyclerViewAdapter.getValues().size() != 0) {
//                doWork();
//            }
//        });
//
...
//        }
//
//        // TODO : Get References From Bundle And Set Here
//
...
//        try {
//            progressDialog.show();
//            casesViewModel.edit(id, roomId, referenceRecyclerViewAdapter.getIds(), complaint);
...
//                if (CasesRepository.work.equals("edit")) {
//                    if (integer == 1) {
