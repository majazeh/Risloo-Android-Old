...
//            }
//
//            if (!roomId.isEmpty() && !casseId.isEmpty() && !time.isEmpty() && !date.isEmpty() && !period.isEmpty() && !statusId.isEmpty()) {
//                doWork();
//            }
//        });
//
...
//        });
//
//        statusDialog.setOnCancelListener(dialog -> {
//            resetData("statusDialog");
//
//            if (controlEditText.input() != null && controlEditText.input().hasFocus()) {
//                controlEditText.clear(this, controlEditText.input());
//                controlEditText.input().getText().clear();
...
//        if (extras.getString("status_id") != null)
//            statusId = extras.getString("status_id");
//        if (extras.getString("status_title") != null)
//            statusTitle = extras.getString("status_title");
//
//        if (roomId.equals("")) {
...
//
//        if (casseId.equals("")) {
//            caseTextView.setText(getResources().getString(R.string.EditSessionRoom));
...
//                    casseName = "";
//
//                    caseTextView.setText(getResources().getString(R.string.EditSampleCase));
//                    caseTextView.setTextColor(getResources().getColor(R.color.Mischka));
//                }
//                break;
//            case "roomDialog":
...
//                break;
//            case "statusDialog":
//                statusDialogRecyclerView.setAdapter(null);
//
//                if (statusDialogRecyclerView.getVisibility() == View.VISIBLE) {
//                    statusDialogRecyclerView.setVisibility(View.GONE);
//                }
//                break;
//        }
//    }
...
//        try {
//            progressDialog.show();
//            sessionViewModel.edit(roomId, casseId, time + " " + date, period, statusId);
...
//        if (method.equals("sessionViewModel")) {
...
//                }
//            });
//        } else if (method.equals("caseViewModel")) {
...
//
//                case "getStatus":
//                    if (!statusId.equals(model.get("id").toString())) {
//                        statusId = model.get("id").toString();
//                        statusTitle = model.get("title").toString();
//
//                        statusTextView.setText(statusTitle);
//                        statusTextView.setTextColor(getResources().getColor(R.color.Grey));
//                    } else if (statusId.equals(model.get("id").toString())) {
//                        statusId = "";
//                        statusTitle = "";
//
//                        statusTextView.setText(getResources().getString(R.string.EditSessionStatus));
...
//                }
//            }
//            if (!ExceptionGenerator.errors.isNull("time")) {
//                errorException("time");
//                if (exceptionToast.equals("")) {
//                    exceptionToast = ExceptionGenerator.getErrorBody("time");
//                } else {
//                    exceptionToast += (" و " + ExceptionGenerator.getErrorBody("time"));
//                }
//            }
//            if (!ExceptionGenerator.errors.isNull("date")) {
//                errorException("date");
//                if (exceptionToast.equals("")) {
//                    exceptionToast = ExceptionGenerator.getErrorBody("date");
//                } else {
//                    exceptionToast += (" و " + ExceptionGenerator.getErrorBody("date"));
//                }
//            }
//            if (!ExceptionGenerator.errors.isNull("period")) {
//                periodEditText.setBackgroundResource(R.drawable.draw_16sdp_border_violetred);
//                if (exceptionToast.equals("")) {
//                    exceptionToast = ExceptionGenerator.getErrorBody("period");
//                } else {
//                    exceptionToast += (" و " + ExceptionGenerator.getErrorBody("period"));
//                }
//            }
