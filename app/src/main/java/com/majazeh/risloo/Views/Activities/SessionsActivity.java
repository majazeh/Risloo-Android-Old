...
//                                sessionsViewModel.sessions(search);
//                                observeWork();
//                            }
...
//    }
//
//    private void launchSessions() {
//        try {
//            sessionsViewModel.sessions(search);
//            SessionsRepository.sessionsPage = 1;
//            observeWork();
//        } catch (JSONException e) {
//            e.printStackTrace();
//        }
...
//        SessionsRepository.workState.observe((LifecycleOwner) this, integer -> {
//            if (SessionsRepository.work.equals("getSessions")) {
//                finished = false;
//                loading = true;
//                if (integer == 1) {
//                    if (sessionsViewModel.getSessions() != null) {
//                        // Show Sessions
//
...
//
//                        sessionsRecyclerViewAdapter.setSessions(sessionsViewModel.getSessions());
//                        if (SessionsRepository.sessionsPage == 1) {
...
//
//                    loading = false;
//                    SessionsRepository.sessionsPage++;
//
//                    resetData("search");
//
//                    finished = true;
//
//                    SessionsRepository.workState.removeObservers((LifecycleOwner) this);
//                } else if (integer != -1) {
//                    if (sessionsViewModel.getSessions() == null) {
//                        // Sessions is Empty
//
