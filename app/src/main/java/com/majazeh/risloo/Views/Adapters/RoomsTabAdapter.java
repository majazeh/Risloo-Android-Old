...
public class RoomsTabAdapter extends FragmentPagerAdapter {
    ...
    public RoomsTabAdapter(@NonNull FragmentManager fragmentManager, int behavior, Activity activity, boolean token) {
