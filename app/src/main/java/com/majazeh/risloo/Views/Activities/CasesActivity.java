...
//            if (CasesRepository.work.equals("getCases")) {
//                finished = false;
//                loading = true;
//                if (integer == 1) {
//                    if (casesViewModel.getCases() != null) {
//                        // Show Cases
//
...
//
//                        casesRecyclerViewAdapter.setCases(casesViewModel.getCases());
//                        if (CasesRepository.casesPage == 1) {
