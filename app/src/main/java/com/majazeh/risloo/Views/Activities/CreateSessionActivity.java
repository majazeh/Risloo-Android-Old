...
//        statusFrameLayout = findViewById(R.id.activity_create_session_status_frameLayout);
//
//        roomLinearLayout = findViewById(R.id.activity_create_session_room_linearLayout);
//
...
//            }
//
//            if (!room.isEmpty() && !casse.isEmpty() && !time.isEmpty() && !date.isEmpty() && !period.isEmpty() && !status.isEmpty()) {
//                doWork();
//            }
//        });
//
...
//        try {
//            progressDialog.show();
//            sessionViewModel.create(room, casse, time + " " + date, period, status);
...
//                if (SessionRepository.work.equals("create")) {
//                    if (integer == 1) {
//                        setResult(RESULT_OK, null);
//                        finish();
//
...
//
//                        statusTextView.setText(model.get("title").toString());
