...
public class AllCentersFragment extends Fragment {
    ...
    public AllCentersFragment(@NonNull Activity activity) {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup viewGroup, @Nullable Bundle savedInstanceState) {
        View view = LayoutInflater.from(activity).inflate(R.layout.fragment_all_centers, viewGroup, false);
    ...
    private void initializer(View view) {
        ...
        centersRecyclerView = view.findViewById(R.id.fragment_all_centers_recyclerView);
        ...
        pagingProgressBar = view.findViewById(R.id.fragment_all_centers_progressBar);
            ...
            public void onScrolled(@NonNull RecyclerView recyclerView, int dx, int dy) {
                ...
                if (dy > 0) {
                    ...
                    if ((visibleItemCount + pastVisibleItems) >= totalItemCount) {
                        try {
                            if (!((CentersActivity) Objects.requireNonNull(getActivity())).loadingAll) {
                                pagingProgressBar.setVisibility(View.VISIBLE);
                                ((CentersActivity) Objects.requireNonNull(getActivity())).centerViewModel.centers(((CentersActivity) Objects.requireNonNull(getActivity())).search);
    ...
    private void setData() {
        if (((CentersActivity) Objects.requireNonNull(getActivity())).centerViewModel.getAll() != null) {
            for (int i = 0; i < ((CentersActivity) Objects.requireNonNull(getActivity())).centerViewModel.getAll().size(); i++) {
                expands.put(i, false);
            }

            centersAdapter.setCenter(((CentersActivity) Objects.requireNonNull(getActivity())).centerViewModel.getAll(), expands, "all");
    ...
    public void notifyRecycler() {
        ...
        ((CentersActivity) Objects.requireNonNull(getActivity())).loadingAll = false;
