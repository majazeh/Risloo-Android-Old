...
public class AllCentersFragment extends Fragment {
    ...
    public AllCentersFragment(Activity activity) {
    ...
    private void setData() {
        if (((CentersActivity) Objects.requireNonNull(getActivity())).centerViewModel.getAll() != null) {
            ...
            adapter.setCenter(((CentersActivity) Objects.requireNonNull(getActivity())).centerViewModel.getAll(), expands, "all", ((CentersActivity) Objects.requireNonNull(getActivity())).centerViewModel);
